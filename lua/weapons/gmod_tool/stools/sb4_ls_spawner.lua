...
TOOL.Category = "SBEP" --TODO: Change for Sb4
...
generators.energy[1].Name = "Sample Energy Generator"
generators.energy[1].Model = "models/props_borealis/bluebarrel001.mdl" --Your entity's model
generators.energy[1].EntityClass = "prop_physics"
generators.energy[1].EntityDescription = "A test entity that isn't real and won't do anything"

generators.air = {}
generators.air[1] = {}
generators.air[1].Name = "My First Air Generator"
generators.air[1].Model = "models/props_borealis/mooring_cleat01.mdl"
generators.air[1].EntityClass = "prop_physics"
generators.air[1].EntityDescription = "An Air Generator. Not really just a prop to test"
